...
public class S3StateRepositoryTest {
	...
	public void test() {
		...
		assertThat(actualFs.getParameterNames()).isEqualTo(new HashSet<String>() {{ add("key1"); }});
		...
		assertThat(actualFs.getParameterNames()).isEqualTo(new HashSet<String>() {{ add("key2"); }});
	}
