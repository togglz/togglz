...
/**
 * Implementation of {@link StateRepository} that publishes a {@link FeatureStateChangedEvent} when the {@link StateRepository#setFeatureState(FeatureState)} method is called
